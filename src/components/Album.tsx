...
const Album = (props: { album: any, cUUID: number, handleInfo: Function; }) => {
    ...
    function handleDropdown() {
        ...
        console.log("cUUID: ",props.cUUID);
    }

    return (
        <div class={styles.albumContainer}>
            <div class={styles.stackBox} style={{backgroundColor: (stackColors[props.album.stack] || 'gray')}}>
            </div>
            ...
            <div class={styles.nameAndGenreBox}>
                ...
                {props.album.is_new && <div class={styles.newBox}>New!</div>}
            ...
            <button id="dropdown" onClick={handleDropdown} class={styles.dropdownBox}>
