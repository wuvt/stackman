...
const Album = (props: { album: any, cUUID: string, playingUUID: string, cID: number, handleShowInfo: Function, handlePlay: Function; }) => {
    ...
    return (
        ...
        <div class={styles.albumContainer}>
            ...
            <button id="info" onClick={() => props.handleShowInfo(props.album.uuid)} class={props.album.uuid===props.cUUID ? styles.infoBoxOn: styles.infoBoxOff}>
            ...
            <button id="dropdown" ref={dButtonRef} onClick={() => setDropdownOn((prevState: any) => !prevState)} className={styles.dropdownBox}>
